...
<svg viewBox="0 -0.5 25 25" fill="none" in:fly={{ y: '16', delay: 125 }} out:fly={{ y: '16' }}>
	<path
		fill-rule="evenodd"
		clip-rule="evenodd"
	...
	/>
	<path d="M17.029 16.5295L19.5 19.0005" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
</svg>
